...
var index1 = {
  ...
  jigsaw: "For displays in the jigsaw block. See https://minecraft.wiki/w/Jigsaw_Block ",
  ...
  notification: "`notification` contains the display messages of items with lock_in_inventory [components](https://minecraft.wiki/w/Item_components)",
  ...
  portfolioScreen: "For use with the deprecated [camera](https://minecraft.wiki/w/Camera)",
